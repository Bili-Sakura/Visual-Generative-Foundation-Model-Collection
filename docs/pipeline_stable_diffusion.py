...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> # Local one-stop custom pipeline loading
        >>> model_dir = Path("/path/to/modelname-diffusers/variant-name")
        >>> dtype = torch.float16
